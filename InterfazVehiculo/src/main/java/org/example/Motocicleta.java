...
public class Motocicleta implements Vehiculo {
    ...
    public void hacerCaballito(){
        System.out.println("Haciendo un caballito con la motocicleta de " + this.centimetrosCubicos + " CC");
    }

    @Override
    public boolean encender() {
        System.out.println("La motocicleta se esta encendiendo ...");
        return true;
    }
    ...
    public boolean apagar() {
        System.out.println("La motocicleta se esta apagando ...");
        return true;
    }
}
